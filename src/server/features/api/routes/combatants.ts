...
export function registerCombatantRoutes(router: RequestRouter) {
    router.route("/api/combatants", {
        GET: () => {
    ...
    router.route("/api/combatants/:id", {
        GET: ({ params }) => {
    ...
    router.route("/api/combatants/:id/resources", {
        PATCH: async ({ req, params }) => modifyCombatantValue(req, params[0], "resources"),
    });
    router.route("/api/combatants/:id/surges", {
        PATCH: async ({ req, params }) => modifyCombatantValue(req, params[0], "surges"),
    });
}
